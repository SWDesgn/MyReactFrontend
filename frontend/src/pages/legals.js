...
function Legals() {
  return (
    <section className="Legals">
      {/*---Impressum---*/}
      <h2>Impressum</h2>
      <h3 className="bold">Angaben gemäß § 5 TMG</h3>
      <p>Altergott Webdesign</p>
      <p>Lange Äcker 1</p>
      <p>71543 Wüstenrot</p>
      <p>Deutschland</p>
      <h3 className="bold">Kontakt</h3>
      <p>Telefon: 0 1590 8167673</p>
      <p>E-Mail: kontakt@altergottwebdesign.com</p>
      <h3 className="bold">
      ...
      <p>
        Telefon: 0 1590 8167673
        <br />
        E-Mail: kontakt@altergottwebdesign.com
      </p>
      <p>
